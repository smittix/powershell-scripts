...
[CmdletBinding()]
Param (
	[string]$Title = "The Health Store, Employee Directory",
    
	[string[]]$SearchOU = ("OU=Buying","OU=Accounts"),
    [String[]]$LocationDefault = (""),
    
    [ValidateScript({Test-Path $_ -PathType Container})]
	[string]$OutputPath = "c:\users\jamess\desktop",
    
    [ValidateScript({Test-Path $_})]
    [string]$HTMLPath,
    
    [ValidatePattern("FirstName|LastName|LNLink|LNLinkPic|FNLink|FNLinkPic|Ext|Department|Title|Fax|Email|Location|Link|Cell|Description")]
    [string]$Fields = "LastName,FirstName,Title,Location,Ext,Cell,Fax,Email",
    
    [ValidatePattern("FirstName|LastName|Ext|Department|Title|Fax|Email|Location|Link|Cell|Manager")]
...
$Regex = "Picture|LastName|FirstName|LNLink|LNLinkPic|FNLink|FNLinkPic|Ext|Department|Title|Fax|Email|Location|Link|Cell|Description"
...
$PropertiesToLoad = "SamAccountName,useraccountcontrol,distinguishedname,GivenName,sn,Title,description,department,physicaldeliveryofficename,TelephoneNumber,Mobile,facsimiletelephonenumber,mail,thumbnailphoto,wwwhomepage,description"
